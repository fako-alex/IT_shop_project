...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ url('')}}/assets/images/page-header-bg.jpg')">
        <div class="container">
            ...
            @else
                <h1 class="page-title">Recherche de : {{ Request::get('q') }} </h1>
            @endif
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="toolbox">
                        <div class="toolbox-left">
                            <div class="toolbox-info">
                                Affichage de <span> {{ $getProduct->total()}}  sur {{ $getProduct->perPage()}} </span> Produits
                                {{-- Affichage de <span>{{ $getProduct->total()}} </span> Produit(s) --}}
                            </div>
                        </div>
                ...
                <aside class="col-lg-3 order-lg-first">
                    <form id="FilterForm" method="post" action="">
                        {{ csrf_field() }}
                        <input type="hidden" name="q" value="{{ !empty(!empty(Request::get('q'))) ? Request::get('q') : ''}}" >
