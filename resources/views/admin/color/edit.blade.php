                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>Nom de la couleur <span style="color: red"> *</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control"required value="{{old('code', $getRecord->code)}}" name="code" placeholder="Saisir le code de la couleur EXP:#FFFAG">
